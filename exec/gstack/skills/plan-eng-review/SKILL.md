...
description: "Eng manager-mode plan review. Lock in architecture, data flow, diagrams, edge cases, test coverage, and performance. Walks through issues interactively with opinionated recommendations."
allowed-tools:
  - Read
  - Grep
  - Glob
